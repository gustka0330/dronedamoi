...
export const metadata: Metadata = {
  ...
  description:
    '현직 초등교사 윤현삼의 학생드론교육 전문 플랫폼. 초등학교 드론수업, 드론코딩, 드론촬영, 드론축구, 학교자율시간, 교사연수 및 교육기관 출강 프로그램을 제공합니다.',
  ...
  openGraph: {
    ...
    description:
      '현직 초등교사 윤현삼의 학생드론교육 전문 플랫폼. 초등 드론수업, 코딩, 촬영, 드론축구, 학교자율시간, 교원연수 출강.',
    images: [
      {
        url: '/images/hero.jpg',
        width: 1200,
  ...
  twitter: {
    ...
    title: '윤현삼 | 학생드론교육 전문가 | DRONEDAMOI DRONE SCHOOL',
    description:
      '현직 초등교사 윤현삼의 학생드론교육 전문 플랫폼. 교실에서 시작해 세계무대까지.',
